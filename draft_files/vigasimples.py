...
fck=25*10**6        #Em Pa
CA =50              #
cobrimento = 0.020  #Em metros
estribo    = 0.005  #Em metros
Mk = 14.6*1000    #Em Newtons.Metros
Ey = 210*10**9      #Em Pa - modulo do aco
d   = h-cobrimento-estribo # 0.06 eh uma estimativa media da altura do centro de gravidade das armaduras
